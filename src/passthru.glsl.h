...
/*
    ...
    Cmdline:
        sokol-shdc -i shaders/passthru.glsl -o src/passthru.glsl.h -l metal_macos

    Overview:
    =========
    Shader program: 'passthru':
        Get shader desc: passthru_shader_desc(sg_query_backend());
        Vertex Shader: passthru_vs
        Fragment Shader: passthru_fs
        Attributes:
            ATTR_passthru_position => 0
            ATTR_passthru_texcoord => 1
    Bindings:
        Image 'tex':
...
#error "Please include sokol_gfx.h before passthru.glsl.h"
#endif
...
#endif
#endif
#define ATTR_passthru_position (0)
#define ATTR_passthru_texcoord (1)
#define IMG_tex (0)
#define SMP_smp (0)
/*
...
*/
static const uint8_t passthru_vs_source_metal_macos[452] = {
...
*/
static const uint8_t passthru_fs_source_metal_macos[391] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
static inline const sg_shader_desc* passthru_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_METAL_MACOS) {
        static sg_shader_desc desc;
        static bool valid;
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)passthru_vs_source_metal_macos;
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = (const char*)passthru_fs_source_metal_macos;
