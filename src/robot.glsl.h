...
/*
    ...
    Cmdline:
        sokol-shdc -i shaders/robot.glsl -o src/robot.glsl.h -l metal_macos

    Overview:
    =========
    Shader program: 'robot':
        Get shader desc: robot_shader_desc(sg_query_backend());
        Vertex Shader: robot_vs
        Fragment Shader: robot_fs
        Attributes:
            ATTR_robot_position => 0
            ATTR_robot_texcoord => 1
    Bindings:
        Uniform block 'robot_vs_params':
            C struct: robot_vs_params_t
            Bind slot: UB_robot_vs_params => 0
        Image 'tex':
...
#error "Please include sokol_gfx.h before robot.glsl.h"
#endif
...
#endif
#endif
#define ATTR_robot_position (0)
#define ATTR_robot_texcoord (1)
#define UB_robot_vs_params (0)
#define IMG_tex (0)
#define SMP_smp (0)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct robot_vs_params_t {
    glm::mat4 mvp;
    glm::vec4 color;
} robot_vs_params_t;
#pragma pack(pop)
/*
    ...
    vertex main0_out main0(main0_in in [[stage_in]], constant robot_vs_params& _19 [[buffer(0)]])
    {
        main0_out out = {};
...
*/
static const uint8_t robot_vs_source_metal_macos[629] = {
    ...
    0x6f,0x62,0x6f,0x74,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x0a,0x7b,
    0x0a,0x20,0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x6d,0x76,
    0x70,0x3b,0x0a,0x20,0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x20,0x63,0x6f,
    ...
    0x72,0x6f,0x62,0x6f,0x74,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x26,
    ...
    0x2e,0x78,0x2c,0x20,0x69,0x6e,0x2e,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x2e,
    ...
    0x63,0x6f,0x6c,0x20,0x3d,0x20,0x5f,0x31,0x39,0x2e,0x63,0x6f,0x6c,0x6f,0x72,0x3b,
...
/*
    ...
    {
        main0_out out = {};
        out.frag_color = tex.sample(smp, in.uv) * in.col;
        return out;
    }

*/
static const uint8_t robot_fs_source_metal_macos[432] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    ...
    0x29,0x20,0x2a,0x20,0x69,0x6e,0x2e,0x63,0x6f,0x6c,0x3b,0x0a,0x20,0x20,0x20,0x20,
    0x72,0x65,0x74,0x75,0x72,0x6e,0x20,0x6f,0x75,0x74,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,

};
static inline const sg_shader_desc* robot_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_METAL_MACOS) {
        static sg_shader_desc desc;
        static bool valid;
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)robot_vs_source_metal_macos;
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = (const char*)robot_fs_source_metal_macos;
